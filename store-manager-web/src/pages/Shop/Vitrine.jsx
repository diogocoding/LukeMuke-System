    ...
    <div className="min-h-screen bg-neutral-900 text-white font-sans">
      ...
      <header className="bg-black/95 border-b border-neutral-800 shadow-lg sticky top-0 z-20 backdrop-blur-xl">
        <div className="max-w-6xl mx-auto px-6 py-4 flex justify-between items-center">
          ...
          <div className="flex items-center gap-4">
            ...
            <h1 className="text-2xl font-serif font-bold tracking-wide text-luke-gold">
              Luke Muke Store
            </h1>

            {/* --- Instagram: Ícone + Nome da loja --- */}
            <a
              href={instagramLink}
              target="_blank"
              rel="noopener noreferrer"
              className="hidden sm:flex items-center gap-2 ml-6 px-3 py-1.5 rounded-lg 
                         text-neutral-300 hover:text-luke-gold hover:bg-neutral-800 
          ...
          <button
            ...
            className="relative p-3 bg-luke-gold text-black rounded-full hover:bg-white transition-all shadow-md"
          >
          ...
          {filteredProducts.map((product) => (
            <div
              ...
              className="bg-neutral-800 rounded-xl overflow-hidden shadow-lg border border-neutral-700 
                         hover:border-luke-gold hover:shadow-luke-gold/20 transition-all group"
            >
              <div className="h-72 bg-neutral-900 overflow-hidden relative">
                <img
      ...
      {isCartOpen && (
        <div className="fixed inset-0 z-50 flex justify-end">
          ...
          <div className="relative w-full max-w-md bg-neutral-900 h-full shadow-2xl border-l border-neutral-800 
                          flex flex-col p-6 animate-in slide-in-from-right">

            <div className="flex justify-between items-center mb-6 border-b border-neutral-800 pb-4">
              <h2 className="text-2xl font-serif font-bold text-luke-gold">Seu Carrinho</h2>
            ...
            <div className="mt-6 border-t border-neutral-800 pt-4">
              ...
              <button
                ...
                className="w-full bg-green-600 text-white font-bold py-4 rounded-xl hover:bg-green-500 
                           transition-colors flex items-center justify-center gap-2 shadow-lg shadow-green-900/20"
              >
